			...
			do
			{
				...
				switch (opcion)
				{
					...
					case 1:
						...
						uA = new UsuarioAdministrador(nombre, this._empleado);
						...
						if (posUsuarioA != -1)
						{
							...
							_usuarioAdministrador[posUsuarioA].MenuAdministrador(this._empleado);
							this._empleado = _usuarioAdministrador[posUsuarioA].Empleado;
